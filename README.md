...
app.layout = html.Div(children=[html.H1('US Domestic Airline Flights Performance',
                                ...
                                html.Div([
                                    ...
                                    html.Div([
                                        ...
                                        # Enter your code below. Make sure you have correct formatting.
                                        dcc.Dropdown(id='input-year', options=[{'label': 'Yearly Airline Performance Report', 'value': 'OPT1'}, {'label': 'Yearly Airline Delay Report', 'value': 'OPT2'}], placeholder="Select a report type", style={'width':'80%', 'padding':'3px', 'font-size': '20px', 'text-align-last' : 'center'}),
...
python3 5_Peer_Graded_Assignment_Questions5.py
# Run the app
